...
def example_one():
    ...
    """
    image = cv2.imread('D:/github/I_Love_Science_Fest/back_end/plots/green_test3.png')
...
def example_two():
    ...
    """
    image = cv2.imread('D:/github/I_Love_Science_Fest/back_end/plots/green_test6.png')
    image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
    plt.imshow(image)
    plt.title('Original Image')
    plt.show()
