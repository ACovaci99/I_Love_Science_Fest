...
class GUI_Main_Page:
    ...
    def __init__(self):
        print(os.path.abspath(os.path.join(os.path.dirname(__file__), '../GUI/vub.png')))

        self.default_img_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../GUI/vub.png'))
        #'G:\\005 - GitRepositories\\1 - Not Updated on Git\\ILSF\\GUI\\vub.png'
        ...
        json_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../GUI/Scales.json'))
        #"G:\\005 - GitRepositories\\1 - Not Updated on Git\\ILSF\\GUI\\Scales.json"
    ...
    def read_image(self, image_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../GUI/vub.png'))):
        # Load the image
